...
task ILMerge -depends Compile {
	...
	Invoke-Expression "$ilmerge_path /targetplatform:v4 /internalize /allowDup /target:library /closed /log /out:$mergedDir\Cedar.HttpCommandHandling.Client.dll $inputDlls"
	...
	Invoke-Expression "$ilmerge_path /targetplatform:v4 /internalize /allowDup /target:library /closed /log /out:$mergedDir\Cedar.HttpCommandHandling.dll $inputDlls"
}
